...
/** Given a map of move lists calculate a linear representation where the most favoured move list is at the head of the
  * list.
  */
...
/** @param moves
  *   The list of moves to rank
  * @param rank
  *   A function that assigns a value to a move where a higher value equates to a preferred move
  * @return
  *   The ranked moves
  */
